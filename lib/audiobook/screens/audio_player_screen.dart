...
import 'package:sight_companion/audiobook/modelSheet/chapters_bottom_sheet.dart';
            ...
            icon: Column(
              children: [
                SizedBox(
                  width: 24,
                  height: 24,
                  child: Image.asset("assets/image/Paper.png"),
                ),
                SizedBox(
                  height: MediaQuery.of(context).size.height * 0.005,
                )
            ...
            icon: Column(
              children: [
                SizedBox(
                  width: 24,
                  height: 24,
                  child: Image.asset("assets/image/Time Square.png"),
                ),
                SizedBox(
                  height: MediaQuery.of(context).size.height * 0.005,
                )
            ...
            icon: Column(
              children: [
                SizedBox(
                  width: 24,
                  height: 24,
                  child: Image.asset("assets/image/Arrow - Down Square.png"),
                ),
                SizedBox(
                  height: MediaQuery.of(context).size.height * 0.005,
                )
                  ...
                  children: [
                    Container(
                      ...
                      decoration: const BoxDecoration(
                        image: DecorationImage(
                          image: AssetImage("assets/image/Volume Up.png"),
                          fit: BoxFit.fill,
                        ),
                      ),
                    ),
                      ...
                      child: Opacity(
                        ...
                        child: AnimatedContainer(
                          ...
                          decoration: const BoxDecoration(
                            image: DecorationImage(
                              image: AssetImage(
                                  "assets/image/Arrow - Left Circle.png"),
                              fit: BoxFit.fill,
                            ),
                          ),
                        ),
                    ...
                    GestureDetector(
                      ...
                      child: AnimatedContainer(
                        ...
                        decoration: BoxDecoration(
                          image: DecorationImage(
                            image: isPlaying
                                ? const AssetImage("assets/image/pause.png")
                                : const AssetImage("assets/image/Play2.png"),
                            fit: BoxFit.fill,
                          ),
                        ),
                      ),
                      ...
                      child: Opacity(
                        ...
                        child: AnimatedContainer(
                          ...
                          decoration: const BoxDecoration(
                            image: DecorationImage(
                              image: AssetImage(
                                  "assets/image/Arrow - Right Circle.png"),
                              fit: BoxFit.fill,
                            ),
                          ),
                        ),
